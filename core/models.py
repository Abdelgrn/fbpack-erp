...
class Atelier(models.Model):
    ...
    description = models.TextField("Description", blank=True)
    responsable = models.ForeignKey('Employee', on_delete=models.SET_NULL, null=True, blank=True, related_name='ateliers_geres', verbose_name="Responsable")
...
class PlanMaintenancePreventive(models.Model):
    ...
    technicien_defaut = models.ForeignKey('Employee', on_delete=models.SET_NULL, null=True, blank=True, related_name='plans_preventifs_assignes', verbose_name="Technicien par défaut")
...
class AlerteMaintenance(models.Model):
    ...
    machine = models.ForeignKey(Machine, on_delete=models.CASCADE, null=True, blank=True, related_name='alertes', verbose_name="Machine")
...
class OrdreFabrication(models.Model):
    ...
    client = models.ForeignKey(Client, on_delete=models.CASCADE, verbose_name="Client", related_name='ordres_fabrication')
    produit = models.ForeignKey(TechnicalProduct, on_delete=models.CASCADE, verbose_name="Produit fini", related_name='ordres_fabrication')
    opportunite = models.ForeignKey(Opportunite, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Opportunité liée")
...
class CalculTempsProduction(models.Model):
    ...
    machine_impression = models.ForeignKey(Machine, on_delete=models.SET_NULL, null=True, blank=True, related_name='calculs_impression', verbose_name="Machine Impression")
    ...
    machine_decoupe = models.ForeignKey(Machine, on_delete=models.SET_NULL, null=True, blank=True, related_name='calculs_decoupe', verbose_name="Machine Découpe")
...
class FicheProductionJournaliere(models.Model):
    ...
    machine = models.ForeignKey(Machine, on_delete=models.SET_NULL, null=True, blank=True, related_name='fiches_journalieres', verbose_name="Machine")
    ...
    client = models.ForeignKey(Client, on_delete=models.SET_NULL, null=True, blank=True, related_name='fiches_journalieres', verbose_name="Client / Motif")
...
class Employee(models.Model):
    ...
    machine_affectee = models.ForeignKey(Machine, on_delete=models.SET_NULL, null=True, blank=True, related_name='operateurs', verbose_name="Machine/Ligne affectée")
...
class Skill(models.Model):
    ...
    description = models.TextField("Description", blank=True)
    machine_associee = models.ForeignKey(Machine, on_delete=models.SET_NULL, null=True, blank=True, related_name='competences_requises', verbose_name="Machine associée")
...
class MachineAuthorization(models.Model):
    ...
    machine = models.ForeignKey(Machine, on_delete=models.CASCADE, related_name='operateurs_autorises', verbose_name="Machine")
    statut = models.CharField("Statut", max_length=20, choices=STATUT_CHOICES, default='EN_ATTENTE')
...
class ChatMessage(models.Model):
    ...
    of_lie = models.ForeignKey(OrdreFabrication, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="OF lié")
