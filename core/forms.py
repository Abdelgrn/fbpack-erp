...
class ClientForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'ca_estime':   forms.NumberInput(attrs={'class': INPUT_STYLE, 'step': '0.1', 'placeholder': 'Ex: 5000'}),
...
class OpportuniteForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'status':             forms.Select(attrs={'class': SELECT_STYLE}),
            'valeur_estimee':     forms.NumberInput(attrs={'class': INPUT_STYLE, 'step': '0.1', 'placeholder': 'Ex: 5000'}),
